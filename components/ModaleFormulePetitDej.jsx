        ...
        <View style={{flexDirection:'column', gap: 10}}>
            <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between'}}>
                ...
                <TouchableOpacity onPress={onClose} >
                    <Text style={{ fontSize: 30, marginBottom:15}}>&times;</Text>
                 </TouchableOpacity>
            </View>
           
            <View style={{ backgroundColor:colors.color6, padding: 10, borderRadius:10}}>
                <Text style={{ textAlign: 'left'}}>Nous vous remercions de votre compréhension mais à ce jour les petits déjeuners ne sont pas 
