      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Paninis')
  ...
  const handleDessert = (product) => {
    if(!selectedProduct ) {
      Toast.show({
          type: 'error',
          text1: 'Attention',
          text2: 'Veuillez sélectionner un panini',
      });
      return;
    }
  ...
  const handleBoisson = (product) => {
    ...
    const handleFormuleSelection = () => {
      const formule = {
        ...
        prix: prix,
        libelle:"Formule Panini",
        formuleImage: require('../../assets/Formule55.jpg'),
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Un Panini grillé, garnitures savoureuses. Le choix parfait pour une pause chaleureuse."</Text>
        </View>
        {/* choix sandwich */}
        <View>
            <Text style={style.choixTitle}>Votre choix de paninis</Text>
