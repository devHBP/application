      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Sandwichs')
  ...
  return (
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Un Sandwich classique, avec une touche du Pain du Jour. Garnitures généreuses et pain frais pour une satisfaction garantie."</Text>
        </View>
        {/* choix sandwich */}
        <View>
    ...
    <View style={style.menu}>
        <View>
          ...
          {selectedSandwich && typeof prix === 'number' && <Text style={{color:colors.color1}}>{prix.toFixed(2)} €</Text>}
          </View>
          <View style={style.bandeauFormule}>
