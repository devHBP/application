      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Wraps')
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Notre Wrap est pratique et savoureux. Des ingrédients bien choisis pour un repas rapide."</Text>
        </View>
        {/* choix sandwich */}
        <View>
