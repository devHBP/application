      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Croques')
  ...
  const handleDessert = (product) => {
    if(!selectedProduct ) {
      Toast.show({
          type: 'error',
          text1: 'Attention',
          text2: 'Veuillez sélectionner un croque',
      });
      return;
    }
  ...
  const handleBoisson = (product) => {
    ...
    const handleFormuleSelection = () => {
      const formule = {
        ...
        prix: prix,
        libelle:"Formule Croque",
        formuleImage: require('../../assets/Formule16.jpg'),
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Notre Croque est l'alliance parfaite du croustillant et du fondant. Idéal pour une petite faim."</Text>
        </View>
        {/* choix sandwich */}
        <View>
            <Text style={style.choixTitle}>Votre choix de croques</Text>
