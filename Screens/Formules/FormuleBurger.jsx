      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Burgers')
  ...
  const handleDessert = async (product) => {
    ...
    if(!selectedProduct ) {
      Toast.show({
          type: 'error',
          text1: 'Attention',
          text2: 'Veuillez sélectionner un burger',
      });
      return;
    }
  ...
  return (
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        {/* choix burger */}
        <View>
            <Text style={style.choixTitle}>Votre choix de burger</Text>
