      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {
            ...
            const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.categorie === 'Salades')
  ...
  const handleDessert = (product) => {
    if(!selectedProduct ) {
      Toast.show({
          type: 'error',
          text1: 'Attention',
          text2: 'Veuillez sélectionner une salade',
      });
      return;
    }
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Notre Salade est un choix léger et nutritif. Des légumes frais, une pointe d'assaisonnement, idéale pour une pause déjeuner."</Text>
        </View>
        {/* choix salade */}
        <View>
