      ...
      useEffect(() => {
        ...
        const fetchProducts = async () => {
          try {  
                ...
                const updatedProducts = products.data.filter(product => product.clickandcollect === true && product.libelle.toLowerCase().startsWith("petite"))
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Découvrez notre Pizza croustillante, garnie avec soin. Un plaisir simple à partager."</Text>
        </View>
        {/* choix sandwich */}
        <View>
