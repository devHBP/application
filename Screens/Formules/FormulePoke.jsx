    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Notre Poke Bowl combine fraîcheur et équilibre. Des ingrédients simples et de qualité pour une pause déjeuner saine."</Text>
        </View>
        {/* choix sandwich */}
        <View>
          ...
          <View style={{...style.choixTitle,flexDirection:'row', gap:10, justifyContent:'center', alignItems:'center'}}>
            ...
            <ScrollView horizontal={true} style={style.scrollProduct} >
                {desserts.map((product, index) => (
                  ...
                  style={{gap:10,flexDirection:'column',  justifyContent:'center', alignItems:'center', margin:10}}
