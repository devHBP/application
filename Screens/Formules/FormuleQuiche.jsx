  ...
  const handleBoisson = (product) => {
    ...
    const handleFormuleSelection = () => {
      const formule = {
        ...
        prix: prix,
        libelle:"Formule Quiche",
        formuleImage: require('../../assets/Formule22.jpg'),
    ...
    <View style={{flex:1}}>
      ...
      <ScrollView ref={scrollViewRef}>
        ...
        <View style={{padding:30}}>
            ...
            <Text style={style.descriptionFormule}>"Nos Quiches sont une invitation à la simplicité. Pâte fine, garniture onctueuse, pour un repas sans chichi."</Text>
        </View>
        {/* choix sandwich */}
        <View>
